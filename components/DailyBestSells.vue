...
<template>
  <section class="mt-12">
    <!-- Header -->
    <div>
      <SectionHeader title="Daily Best Sells" />
    </div>

    <div class="flex gap-5 flex-wrap justify-center">
      <!-- Free delivery card -->
      <div
        class="bg-[#fff] rounded-lg p-6 text-center relative overflow-hidden h-[450px] w-[300px]"
      >
        <!-- Background image -->
        <div
      ...
      <!-- Products card -->
      <div
        class="bg-[#fff] w-[260px] text-center p-5 pt-2 rounded-lg overflow-hidden shadow-sm"
